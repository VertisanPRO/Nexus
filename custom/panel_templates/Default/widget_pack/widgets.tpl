                        ...
                        <tr data-id="{$item['pack']->id}">
                          ...
                          <td>
                            <div class="float-md-right">
                              <a href="{$EDIT_URL}?id={$item['pack']->id}" class="btn btn-success btn-sm"><i
                                  class="fas fa-edit"></i></a>
                              <a href="{$SETTING_URL}?action=edit&w={$item['widget']->id}" class="btn btn-success btn-sm"><i
                                  class="fa-solid fa-gear"></i></a>
                              <button onclick="setRemoveID('{$item['pack']->id}')" data-toggle="modal"
                                data-target="#removeModal" class="btn btn-danger btn-sm"><i
