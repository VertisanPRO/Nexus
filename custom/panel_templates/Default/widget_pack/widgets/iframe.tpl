                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="iframe_widget_header"
                                        name="iframe_widget_header"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="iframe_widget_header_url"
                                        name="iframe_widget_header_url"
                                        value="{if isset($IFRAME_WIDGET_HEADER_URL)}{$IFRAME_WIDGET_HEADER_URL}{/if}" />
                                </div>
                                <div class="form-group">
                                    <label for="iframe_widget_url">{$I_WG_URL_LABEL}</label>
                                    <input type="text" class="form-control" id="iframe_widget_url"
                                        name="iframe_widget_url"
                                        value="{if isset($IFRAME_WIDGET_URL)}{$IFRAME_WIDGET_URL}{/if}" />
                                </div>

                                <div class="form-group">
                                    <label for="iframe_widget_icon">{$I_WG_ICON_LABEL}</label>
                                    <input type="text" class="form-control" id="iframe_widget_icon"
                                        name="iframe_widget_icon" placeholder='<i class="fas fa-hand-holding-usd"></i>'
                                        value="{if isset($IFRAME_WIDGET_ICON)}{$IFRAME_WIDGET_ICON|escape:'html'}{/if}" />
                                </div>

                                <div class="form-group">
                                    <input type="hidden" name="token" value="{$TOKEN}" />
                                    <button style="width: 100%; margin-top: 20px;" type="submit" name="wg_save"
