                    ...
                    {foreach from=$CATEGORIES item=category}
                        {if isset($category.subcategories) && count($category.subcategories)}
                            <div class="ui pointing dropdown link item">
                                ...
                                <div class="menu">
                                    <a class="{if $category.active}active {/if}item"
                                        href="{$category.url}">{$category.title}</a>
                                    {foreach from=$category.subcategories item=subcategory}
                                        <a class="{if $subcategory.active}active {/if}item"
                                ...
                                <div class="four wide column">
                                    <div class="ui card" style="height: 100%">
                                        ...
                                        <div class="center aligned content">
                                            ...
                                            {if $package.sale_active}
                                                <span
                                                    style="color: #dc3545;text-decoration:line-through;">{$CURRENCY}{$package.price}</span>
                                            {/if}
