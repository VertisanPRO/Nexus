...
<div class="ui centered three stackable cards" id="servers">
  ...
  <div class="ui fluid card center aligned server" id="server{$server->id|escape}" data-id="{$server->id|escape}"
    data-bungee="{$server->bungee|escape}" data-players="{$server->player_list|escape}">
    <div class="content">
      <div class="header">
