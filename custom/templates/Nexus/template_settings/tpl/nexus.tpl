...
<div class="row">
  ...
  <div class="col-sm-9">
    <div class="tab-content" id="v-pills-tabContent">
      ...
      <div class="tab-pane fade {if $TPL_NAME_SESSION eq 'colors'}show active{/if}" id="v-pills-colors" role="tabpanel"
        aria-labelledby="v-pills-colors-tab">
        {include file="{$TPL_PATH}colors.tpl"}
      </div>
      <div class="tab-pane fade {if $TPL_NAME_SESSION eq 'navbar'}show active{/if}" id="v-pills-navbar" role="tabpanel"
      ...
      <div class="tab-pane fade {if $TPL_NAME_SESSION eq 'addons'}show active{/if}" id="v-pills-addons" role="tabpanel"
        aria-labelledby="v-pills-addons-tab">
      ...
      <div class="tab-pane fade {if $TPL_NAME_SESSION eq 'embed'}show active{/if}" id="v-pills-embed" role="tabpanel"
        aria-labelledby="v-pills-embed-tab">
        {include file="{$TPL_PATH}embed.tpl"}
      </div>  
      <div class="tab-pane fade {if $TPL_NAME_SESSION eq 'update'}show active{/if}" id="v-pills-update" role="tabpanel"
