			...
			<div class="ui stackable inverted divided grid">
				<div class="five wide column">
					...
					<div class="ui inverted link list">
						...
						<span class="item">Template By Mubeen, <a href="https://tensa.co.ua" target="_blank" rel="nofollow noopener">xGIGABAITx</a>, <a href="https://padow.ru" target="_blank" rel="nofollow noopener">PadowYT2</a> & Sylensky</span>
						{if $PAGE_LOAD_TIME}
