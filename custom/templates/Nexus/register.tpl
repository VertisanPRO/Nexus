				...
				<form class="ui form" action="" method="post" id="form-register">
					...
					<div class="field">
						...
						<input type="text" name="{if isset($MINECRAFT)}nickname{else}username{/if}" id="username"
							...
							placeholder="{$NICKNAME}" tabindex="1">
					</div>
					{if isset($MINECRAFT)}
					<div class="field">
						<label>{$MINECRAFT_USERNAME}</label>
						<input type="text" name="username" id="mcname" value="{$USERNAME_VALUE}"
							placeholder="{$MINECRAFT_USERNAME}" tabindex="2">
					</div>
					{/if}
					{else}
					{if isset($MINECRAFT)}
					<div class="field">
						<label>{$MINECRAFT_USERNAME}</label>
						<input type="text" name="username" id="mcname" value="{$USERNAME_VALUE}"
							placeholder="{$MINECRAFT_USERNAME}" tabindex="1">
					</div>
					{else}
					<div class="field">
					...
					<div class="field">
						<label>{$EMAIL}</label>
						<input type="email" name="email" id="email" value="{$EMAIL_VALUE}" placeholder="{$EMAIL}"
							tabindex="3">
					</div>
					<div class="field">
					...
					<div class="field">
						...
						<input type="password" name="password_again" id="password_again"
							placeholder="{$CONFIRM_PASSWORD}" tabindex="5">
					</div>
					...
					<input type="submit" class="ui primary button" style="width: 100%;" value="{$REGISTER}"
						tabindex="8">
