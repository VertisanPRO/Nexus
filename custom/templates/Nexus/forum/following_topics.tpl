                ...
                <h3 class="ui header">
                    ...
                    {if count($TOPICS_LIST)}
                        <div class="res right floated">
                            <a class="ui mini negative button" href="#" data-toggle="modal" data-target="#modal-delete">{$UNFOLLOW_ALL}</a>
                        </div>
                    {/if}
                </h3>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="ui stackable middle aligned grid">
                                                <div class="row" onclick="window.location.href = '{$topic.last_post_link}'" style="cursor: pointer">
                                                    ...
                                                    <div class="four wide column">
                                                        <h5 class="ui image header">
                                                            ...
                                                            <div class="content">
                                                                <a href="{$topic.reply_author_link}" data-toggle="popup" data-poload="{$USER_INFO_URL}{$topic.reply_author_id}" style="{$topic.reply_author_style}">{$topic.reply_author_nickname}</a>
                                                                <div class="sub header" data-toggle="tooltip" data-content="{$topic.reply_date_full}">{$topic.reply_date}</div>
                                                            </div>
                                                        </h5>
                                                    </div>
