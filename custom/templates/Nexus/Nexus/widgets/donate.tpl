<div class="ui fluid card" id="widget-latest-posts">
	<div class="content">
		<a class="ui {if isset($WIDGET_LABEL_COLOR)} {$WIDGET_LABEL_COLOR}{else} violet{/if} ribbon label"><i
				class="fas fa-donate"></i> Donate</a>
...
">
							...
							<input type="hidden" name="business"
								value="{if isset($DONATE_EMAIL)}{$DONATE_EMAIL}{else}lectrichost@gmail.com{/if}">
