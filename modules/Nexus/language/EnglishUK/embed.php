...
$language = array(
    ...
    'embed_keywords_info_label' => 'Search engines make use of keywords to help determine what to show for searches made by users. Seperate with \',\' e.g mc, server, website etc.',
